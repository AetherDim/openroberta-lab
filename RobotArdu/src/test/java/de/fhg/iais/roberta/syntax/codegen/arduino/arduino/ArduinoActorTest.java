...
public class ArduinoActorTest extends ArduinoAstTest {
    ...
    public void analogDigitalPinWriteTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(digitalOutput, analogOutput);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
    ...
    public void multiIncludeTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(rfid1, rfid2, servoMotor1, servoMotor2);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
